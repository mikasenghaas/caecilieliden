...
The result was a an app to support fast, low-attention interactions during time-critical check-in situations. While it may not be groundbreaking in its form, its strength lies in how well it responds to the real, situated needs expressed by the volunteers. As seen in the flowcharts below, the sign-up and payment flow has been simplified. The most central feature is a QR code that is generated once signed up. This allows volunteers to scan participants quickly at events. In addition, a clear overview of upcoming events and a calendar view are presented. A noticeable constraint of the solution is the limited involvement of the parents, who would also use the platform. If developed further, they would be included as well.
