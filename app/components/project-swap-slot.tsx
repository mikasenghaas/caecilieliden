...
const PROJECTS: Record<ProjectKey, { href: string; title: string; year: string; image?: typeof ledImage }> = {
  led: {
...
export default function ProjectSwapSlot({ slot }: ProjectSwapSlotProps) {
  ...
  return <ProjectLink href={project.href} title={project.title} year={project.year} image={project.image} />;
}
