      ...
      <div className="min-h-screen bg-white text-foreground">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {activeSlide.id === "concept" ? (
                    <div className={`grid grid-cols-1 md:grid-cols-12 gap-6 ${CONTENT_HEIGHT}`}>
                      <div className="md:col-span-5 flex flex-col md:h-full">
                        <div className={`relative w-full ${MEDIA_HEIGHT_MOBILE} md:h-auto md:flex-1 overflow-hidden`}>
                          <Image
                            src={strangersImage}
                          ...
                          <div className="absolute inset-x-0 bottom-0 p-4 text-xs sm:text-sm leading-relaxed text-white space-y-3">
                            <p>
                              Public transport is a space where passengers are neither working
                              nor resting, and many fill the void with their phones or
                              daydreaming.
                            </p>
                            <p>
                              I saw it as a site for something more meaningful and playful,
                              which is why this project explores how{" "}
                              <strong className="text-white">play</strong> can open up the
                              liminal, in-between state of public transport, while
                              experimenting with how play can be used as part of design
                              processes.
                            </p>
                          </div>
                        </div>
                        <p className="text-left text-xs sm:text-sm leading-relaxed mt-3 px-4 shrink-0">
                          I ended up designing an <strong>interactive LED system</strong>,
                          where passengers can interact with each other indirectly.
                          From your
                          seat, a joystick lets you steer a small light, or &quot;character,&quot;
                          along LED strips that wrap around the vehicle&apos;s architecture. Along
                          the way you can blink at, chase, and high-five the lights of fellow
                          passengers.
                        </p>
                      </div>

                      <div className={`md:col-span-7 relative w-full ${VIDEO_HEIGHT_MOBILE} overflow-hidden`}>
                        <iframe
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-12 gap-6 ${CONTENT_HEIGHT}`}>
                      <div className="md:col-span-5 flex flex-col justify-start">
                        ...
                        <p className="text-xs sm:text-sm leading-relaxed mt-3">
                          ...
                          design process that I came to understand why play matters and why public
                          transport is such an interesting design space.
                        </p>
                      </div>
                        ...
                        <div className="absolute inset-0 flex flex-col justify-end items-start p-4 sm:p-6 text-left text-xs sm:text-sm leading-relaxed text-white space-y-4">
                          <div>
                            ...
                            <p>
                              ...
                              not for anything, and that&apos;s exactly why it matters to me. Play is
                              a small refusal, a moment where we take a space back for ourselves.
                            </p>
                          </div>

                          <div>
                            <p className="font-bold mb-1">And why public transport?</p>
                            <p>
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-[0.8fr_19.6rem_1fr] gap-6 ${CONTENT_HEIGHT}`}>
                      <div className="flex flex-col justify-start space-y-3 text-left text-xs sm:text-sm leading-relaxed">
                        <p>
                          ...
                          through <strong>&quot;revealing&quot;</strong>. This meant staying open
                          to what emerged, instead of &quot;enframing,&quot; which forces the
                          material into a predetermined shape.
                        </p>
                        <p>
                          From academics, I am used to working through enframing, sorting the
                          design process into categories and often following the double
                          diamond model. I was interested in trying something different like
                          revealing, because I wanted the process to feel like I was playing,
                          making my own rules and following my intuition of what the next step
                          was.
                        </p>
                      </div>
                      ...
                      <div className="relative w-full md:w-fit md:h-full overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center items-start p-4 sm:p-6 text-left text-xs sm:text-sm leading-relaxed text-white">
                          <p>
                            In practice, this meant starting from what motivated me,
                            making people play, and seeing where it led me. To make people play, I
                            needed to understand the openings and limitations of public transport.
                            I gave a friend prompts to reflect on what play could be on public
                            transport, then started generating ideas from her input. Eventually I
                            came up with a concept that went through phases of adjustment, based
                            on input from my conversations with people and things I read.
                          </p>
                        </div>
                      </div>

                      <div className={`flex flex-col gap-6 ${MEDIA_HEIGHT_MOBILE} md:h-full`}>
                        ...
                        <div className="relative w-full flex-1 overflow-hidden">
                          ...
                          />
                          <div className="absolute inset-0 bg-black/45" />
                          <div className="absolute inset-0 flex flex-col justify-center items-start p-4 text-left text-xs sm:text-sm leading-relaxed text-white">
                            <p>
                              The prototype was built with an Arduino Uno, WS2812B LED strips,
                              and custom cardboard controllers, using the FastLED library. The
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-[46.32rem_1fr] gap-6 ${CONTENT_HEIGHT}`}>
                      ...
                      <div className="relative w-full md:w-[46.32rem] md:h-full overflow-hidden">
                        <Image
                        ...
                        <div className="mt-3 md:mt-0 md:absolute md:inset-0 md:flex md:flex-col md:justify-start md:items-start md:p-6 md:text-white text-left text-xs sm:text-sm leading-relaxed space-y-3">
                          <p>
                            Besides smaller and less structured testing, I did one bigger
                            test. Here I planted an upscaled version of the prototype in a
                            student caf&eacute;, on the counter where people waited for their
                            coffee, and sat in the corner to observe.
                          </p>
                          <p>
                      ...
                      <div className="flex flex-col justify-start space-y-3 text-left text-xs sm:text-sm leading-relaxed">
                        <div>
                          <p className="font-bold mb-1 text-[#ED2E85]">What happened?</p>
                          <p>
                            I was really happy to see that people discovered the system
                            unprompted and invented their own games with it, racing lights,
                            trying to &quot;collide,&quot; and sneaking around invisibly by
                            holding down the button, all while interacting with strangers
                            through it.
                          </p>
                          <p className="mt-3">
                        ...
                        <p>
                          The tests confirmed there&apos;s real potential for playful,
                          unplanned interaction between strangers in waiting spaces. Designing
                          for play means designing at the edge of a space&apos;s unwritten
                          rules, its &quot;wiggle space.&quot;
                        </p>
                        <p>
                    ...
                    // the shared frame.
                    <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 ${CONTENT_HEIGHT} text-left text-xs sm:text-sm leading-relaxed`}>
                      <div className="flex flex-col justify-start space-y-3">
                        <p>
                          ...
                          myself spending more time in conversation with the materials, and
                          made several <strong>unplanned discoveries that turned out to be
                          the most important ones of this project.</strong>
                        </p>
                        <p>
                          I discovered that play can be used as a design approach by{" "}
                          <strong>designing the frame, rather than the behaviour.</strong> I
                      ...
                      <div className="flex flex-col justify-start">
                        <p>
                          ...
                          design space, which is where the risk lies. Push too far and it
                          tips into boundary work, where people defend the norm instead of
                          playing with it. The goal isn&apos;t to break the rules of a space,
                          but to nudge just enough that a rule becomes visible and negotiable.
                          This also points to the downside of revealing. I am still not sure
                          what the space of public transport allows, and a more enframed
                          process would likely have covered that early on.
                        </p>
                      </div>
        ...
        <div className="flex fixed inset-x-0 bottom-0 sm:bottom-20 z-40 justify-center px-4 py-4 sm:py-0 bg-white sm:bg-transparent pointer-events-none">
          <div className="pointer-events-auto">
            <SlideNav slides={SLIDES} activeIndex={activeIndex} onSelect={setActiveIndex} />
          </div>
        </div>
      </div>
    </>
